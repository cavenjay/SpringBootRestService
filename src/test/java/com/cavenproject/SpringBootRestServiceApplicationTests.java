...
import com.cavenproject.controller.AddResponse;
import com.cavenproject.controller.Library;
import com.cavenproject.controller.LibraryController;
...
class SpringBootRestServiceApplicationTests {
	...
	public void getBookByAuthorTest() throws Exception
	{
		...
		this.mockMvc.perform(get("/getBooks/author").param("authorname","Jay"))
	...
	public void updateBookTest() throws Exception
	{
		...
		.andExpect(content().json("{\"book_name\":\"TestTest\",\"id\":\"sfe322\",\"isbn\":\"sfe\",\"aisle\":666,\"author\":\"Caven\"}"));
	}
	...
	public void deleteBookTest() throws Exception
	{
		...
		this.mockMvc.perform(delete("/deleteBook").contentType(MediaType.APPLICATION_JSON)
				.content("{\"id\":\"sfe322\"}")).andDo(print()).andExpect(status().isCreated()).andExpect(content().string("Book is deleted!"));
